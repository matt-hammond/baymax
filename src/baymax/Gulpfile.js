...
gulp.task("sass-compile-custom", function () {
    gulp.src("./assets/sass/*.scss")
        .pipe(sass({ includePaths: ["./submodules/govuk_frontend_toolkit/stylesheets/", "./submodules/govuk-elements/public/sass/"], imagePath: '/public/images/' }))
        .pipe(gulp.dest("./wwwroot/public/stylesheets"));
});
...
gulp.task("copy-static", function () {
    gulp.src("./submodules/static/app/assets/images/**/*").pipe(gulp.dest("./wwwroot/public/images"));
    gulp.src("./submodules/static/app/assets/javascripts/**/*").pipe(gulp.dest("./wwwroot/public/javascripts"));

    gulp.src("./submodules/static/app/assets/stylesheets/*.scss").pipe(sass({ includePaths: ["./submodules/govuk_frontend_toolkit/stylesheets/"] })).pipe(gulp.dest("./wwwroot/public/stylesheets"));
